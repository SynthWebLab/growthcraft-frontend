...
export default function AmbassadorEarningsPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-slate-900 font-display">Earnings Report</h1>
        <p className="text-muted-foreground mt-1">Review your payouts, commissions logs, and monthly referral earnings trend.</p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm text-slate-300">
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                <span className="text-xs text-magenta font-semibold uppercase">Verification</span>
                <p className="text-xs text-slate-400 mt-1">Pending rewards require up to 14 days to clear following college cohort enrollment validations.</p>
              </div>
            </div>
          </div>
        </DataCard>
