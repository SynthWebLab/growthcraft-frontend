      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-border bg-gradient-to-br from-graphite via-slate-900 to-graphite p-5 sm:p-8 text-white shadow-2xl">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-3 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 text-xs text-slate-300 pt-1.5">
              <div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-xl border border-white/10 w-fit">
                ...
                <span className="truncate max-w-[280px] sm:max-w-none">Date: {startDate}</span>
              </div>
              <div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-xl border border-white/10 w-fit">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 min-w-[200px] w-full lg:w-auto">
            ...
            <a href="#assignment-form" className="w-full">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 w-full">
              ...
              <div className="space-y-1.5 w-full min-w-0">
                <h3 className="font-bold text-sm sm:text-lg text-foreground flex flex-wrap items-center gap-2 leading-none">
                  {isOnline ? "Virtual Workshop Pass & Meeting" : "Campus Check-in Token"}
        ...
        <div className="lg:col-span-2 space-y-5 sm:space-y-6">
          ...
          <Card className="p-4 sm:p-6 rounded-2xl border border-border bg-white shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
              ...
              <div className="p-3 sm:p-4 rounded-xl bg-slate-50 border border-slate-100/80">
                <span className="text-[10px] sm:text-xs text-muted-foreground block font-medium">Assigned Instructor</span>
                <span className="text-xs sm:text-sm font-bold text-foreground mt-0.5 block truncate">
                  {mentors[0]?.name || "Dr. Vikram Sethi"}
                </span>
              </div>
              <div className="p-3 sm:p-4 rounded-xl bg-slate-50 border border-slate-100/80">
                <span className="text-[10px] sm:text-xs text-muted-foreground block font-medium">Workshop Track</span>
                <span className="text-xs sm:text-sm font-bold text-foreground mt-0.5 block truncate">Full-Stack & Cloud</span>
              </div>
            </div>
          ...
          <Card className="p-4 sm:p-6 rounded-2xl border border-border bg-white shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-[10px] sm:text-xs font-semibold text-muted-foreground">
                {computedStatus === "Closed" ? "Concluded" : computedStatus === "Live" ? "Phase 2 Active" : "Upcoming"}
              </span>
            </div>
          ...
          <Card id="assignment-form" className="p-4 sm:p-6 rounded-2xl border border-border bg-white shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border pb-4">
              <div className="flex items-center gap-2">
                <Code2 className="h-5 w-5 text-magenta shrink-0" />
                <div>
                  <h2 className="text-base sm:text-lg font-bold text-foreground">Workshop Lab Assignment</h2>
                  <p className="text-[11px] sm:text-xs text-muted-foreground">Submit your workshop lab exercise repository & project notes for evaluation.</p>
                </div>
              </div>
              {isSubmitted && (
                ...
                <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100/80 gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] sm:text-xs text-muted-foreground truncate">{m.designation || m.areaOfExpertise || "Workshop Instructor"}</p>
                    </div>
                  </div>
          ...
          <Card className="p-4 sm:p-6 rounded-2xl border border-border bg-gradient-to-br from-amber-500/5 via-slate-50 to-magenta/5 shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base sm:text-lg font-bold text-foreground">Workshop Certificate</h2>
              </div>
            ...
            {!canUnlockCert ? (
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-900 flex items-center gap-2">
                  ...
                  <span className="text-[11px] sm:text-xs font-medium">Verified by Admin • Serial No: GC-WRK-2026-4481</span>
                </div>
