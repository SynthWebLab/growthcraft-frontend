...
export const API_ENDPOINTS = {
  ...
  students: {
    ...
    submitCourseProject: (slug: string) => `/students/courses/workspace/${slug}/submission`,
    trainingPrograms: "/students/training-programs",
    trainingProgramWorkspace: (slug: string) => `/students/training-programs/workspace/${slug}`,
    submitTrainingProgramProject: (slug: string) => `/students/training-programs/workspace/${slug}/submission`,
  ...
  admin: {
    ...
    registrationDetail: (id: string) => `/admin/registrations/${id}`,
  },
  leads: {
    create: "/leads",
  },
